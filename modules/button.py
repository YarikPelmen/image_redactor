...
def label_text():
    ...
    def add_label_text():
        ...
        label.place(relx = 0, rely = 0) 
    buton111 = create_save_text(text = "", command= add_label_text, image= m_im.image_button_save_text)
    buton111.place(relx = 0.33, rely = 0.937)
...
button7 = create_button(text = "text", command= label_text)
...
button12 = create_button(text = "+",command = save_text)
